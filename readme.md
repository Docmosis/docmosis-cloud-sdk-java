...
If you don't already have a Docmosis account you can sign up for a free DWS3 trial
at: [docmosis.com/products/cloud/try.html](https://www.docmosis.com/products/cloud/try.html). 
A DWS3 account should be used in conjunction with our [DWS3 SDK](https://github.com/Docmosis/docmosis-cloud-sdk-java/tree/DWS3)

Please look at the [examples](https://github.com/Docmosis/docmosis-cloud-sdk-java/tree/DWS2/examples) 
on our [github project page](https://github.com/Docmosis/docmosis-cloud-sdk-java/tree/DWS2) 
...
The current release of the jar can be found under [dist](https://github.com/Docmosis/docmosis-cloud-sdk-java/tree/DWS2/dist), or you can 
build the jar yourself with the following steps:

1. Download the [Docmosis Cloud SDK Java (DWS2) project](https://github.com/Docmosis/docmosis-cloud-sdk-java/tree/DWS2)
2. Unzip the package
