 ...
 */
public class MutableRenderResponse extends RenderResponse implements MutableResponseInterface
{
	protected MutableRenderResponse() {}
	...
	public RenderResponse build() {
		return (RenderResponse) this;
	}
