...
/**
 * This class encapsulates a response to a upload template batch request.
 * 
 ...
 * </pre>
 */
public class UploadTemplateBatchResponse extends DocmosisCloudResponse {

	private JobStatus jobStatus = null;
	
	protected UploadTemplateBatchResponse(DocmosisCloudResponse other) {
		super(other);
	}
